...
public class Task2a {
	...
	public static class map2a extends
	...
	public static class reducer2a extends Partitioner<Text, Text> {
		@Override
	...
	public static void main(String[] args) throws IOException,
		...
		job.setMapperClass(map2a.class);
		job.setPartitionerClass(reducer2a.class);
